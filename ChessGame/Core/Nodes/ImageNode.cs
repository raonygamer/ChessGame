...
namespace Core.Nodes
{
    ...
    public class ImageNode : ControlNode
    {
        ...
        public override void Draw(StateContext ctx, GameTime time)
        {
            ...
            if (Texture != null)
            {
                ctx.SpriteBatch.Draw(Texture, Transform.WorldTopLeft, SourceRectangle, Color, Transform.WorldRotation, Transform.Origin * new Vector2(Texture.Width, Texture.Height), Transform.WorldScale, SpriteEffects.None, 0f);
            }
        }
    }
}
